...
class Tests_Public_Property_Carousel_Public extends WP_UnitTestCase {
	...
	public function test_constructor() {
		$obj = new Property_Carousel_Public(
			'property_carousel_propertyhive',
			'1.2.3'
		);
	...
	public function test_enqueue_scripts() {
		$handle = 'property_carousel_propertyhive';
		if ( array_key_exists( $handle, wp_scripts()->registered ) ) {
			wp_deregister_script( $handle );
		}
		$this->assertArrayNotHasKey( 'property_carousel_propertyhive', wp_scripts()->registered );
		...
		$obj->enqueue_scripts();
		$this->assertArrayHasKey( 'property_carousel_propertyhive', wp_scripts()->registered );
	}
	...
	public function test_enqueue_styles() {
		...
		$this->assertArrayNotHasKey( 'property_carousel_propertyhive', wp_styles()->registered );
		...
		$obj->enqueue_styles();
		$this->assertArrayHasKey( 'property_carousel_propertyhive', wp_styles()->registered );
	}
